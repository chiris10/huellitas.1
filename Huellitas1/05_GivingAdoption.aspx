<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="05_GivingAdoption.aspx.cs" Inherits="Huellitas1._05_GivingAdoption" %>
    ...
    <form runat="server">
        ...
        <div class="form-container">
            ...
            <div class="form-label">
                ...
                <asp:TextBox runat="server" type="number" id="edad" class="form-input" onkeypress="return NumCheck(event, this)"></asp:TextBox>
            </div>
            <div class="form-label">
                <label for="peso">Peso (kg):</label>
                <asp:TextBox runat="server" type="number" id="peso" class="form-input" onpaste="return false" onkeypress="return NumCheck(event, this)"></asp:TextBox>
            </div>
            <div class="form-label">
                <label for="foto">Foto:</label>
                <asp:TextBox runat="server" type="file" id="foto" class="form-input"></asp:TextBox>
            </div>
            <div class="form-label">
                <label for="comentario">Comentario:</label>
                <asp:TextBox runat="server" id="comentario" class="form-input"></asp:TextBox>
            </div>
            <asp.Button class="form-button" type="submit">Registrar</asp.Button>
        </div>
        <footer class="footer">
            <div class="container">
                <div class="row">
